...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-96wspc");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-96wspc");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-96wspc");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-96wspc");
			attr(nav, "class", "svelte-96wspc");
			attr(div0, "class", "desktop-nav svelte-96wspc");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-96wspc");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-96wspc");
			attr(div2, "class", "section-container svelte-96wspc");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('lfbgz' in $$props) $$invalidate(3, lfbgz = $$props.lfbgz);
		if ('xulbn' in $$props) $$invalidate(4, xulbn = $$props.xulbn);
		if ('clmrm' in $$props) $$invalidate(5, clmrm = $$props.clmrm);
	};
