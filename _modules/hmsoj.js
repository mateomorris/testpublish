...
function create_if_block(ctx) {
	let div;
	let raw_value = /*item*/ ctx[8].description + "";
	let div_transition;
	let current;
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*items*/ 2) && raw_value !== (raw_value = /*item*/ ctx[8].description + "")) div.innerHTML = raw_value;		},
		i(local) {
			if (current) return;
...
function create_each_block(key_1, ctx) {
	...
	let if_block = /*activeItem*/ ctx[2] === /*i*/ ctx[10] && create_if_block(ctx);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('hhxjt' in $$props) $$invalidate(6, hhxjt = $$props.hhxjt);
