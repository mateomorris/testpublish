...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-z6za4r");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(nav_1, "class", "svelte-z6za4r");
			attr(a, "href", "https://primo.so");
			attr(a, "class", "svelte-z6za4r");
			attr(span, "class", "primo svelte-z6za4r");
			attr(div, "class", "social-links svelte-z6za4r");
			attr(footer, "class", "section-container svelte-z6za4r");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('lfbgz' in $$props) $$invalidate(4, lfbgz = $$props.lfbgz);
		if ('xulbn' in $$props) $$invalidate(5, xulbn = $$props.xulbn);
		if ('clmrm' in $$props) $$invalidate(6, clmrm = $$props.clmrm);
		if ('nav' in $$props) $$invalidate(0, nav = $$props.nav);
		if ('social' in $$props) $$invalidate(1, social = $$props.social);
	};

	return [nav, social, logo, site_nav, lfbgz, xulbn, clmrm];
}
